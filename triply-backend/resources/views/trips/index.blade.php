...
@section('content')
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1>Viaggi</h1>
            <a href="{{ route('trips.create') }}" class="btn btn-outline-primary">
                Aggiungi nuovo
            </a>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <!-- Frontend Show -->
                                <a href="http://localhost:5173/trip/{{ $trip->id }}" class="btn btn-info btn-sm"
                                    title="Vedi nel sito" target="_blank">
                                    <i class="bi bi-globe"></i>
                                    <span class="d-none d-lg-inline"> Sito</span>
                                </a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteModalLabel-{{ $trip->id }}">
                                        ...
                                        <div class="modal-body">
                                            Sei sicuro di voler eliminare "<strong>{{ $trip->title }}</strong>"?
